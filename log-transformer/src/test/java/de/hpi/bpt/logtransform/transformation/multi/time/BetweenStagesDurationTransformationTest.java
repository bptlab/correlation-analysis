...
class BetweenStagesDurationTransformationTest {
    ...
    void transform() throws Exception {
        ...
        var sourceEventLog = new EventLogBuilder()
                ...
                .row(formatter.parse("01-01-2000 09:15"), "Another")
                .row(formatter.parse("01-01-2000 09:30"), "A2")
                .row(formatter.parse("01-01-2000 09:45"), "A1")
                .build()
                .build();
        ...
        assertThat(afterTransformation.get("1")).containsExactly("1", 15, 0);
